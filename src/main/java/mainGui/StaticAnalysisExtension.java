 ...
 */
public class StaticAnalysisExtension extends Extension implements PackageListener {
    /*
    ...
    public void terminate() {
        System.out.println("Static Analysis Extension Terminates");
    }

    public String getDescription () {
        return "Static Code Analysis Tools Extension Manager";
    }
...
class MenuBuilder extends MenuGenerator {
    ...
    public JMenuItem getToolsMenuItem(BPackage aPackage) {
        return new JMenuItem(new SimpleAction("---Static Code Analyis Tools---", "Tools menu:"));
    }
    ...
    class SimpleAction extends AbstractAction {
        ...
        public SimpleAction(String menuName, String msg) {
            //JOptionPane.showMessageDialog(null, "Put extensions here.");
            gui = new StaticToolsGUI();
